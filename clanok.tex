...
\section{The influence of games on children and their development} %\label{part1}
As time passes, younger and younger children start to play video games. ~\cite{children}

...
Video games have a significant ability to catch one's attention and not let it go for long periods of time. Learning on its own, on the other hand, does the exact opposite. Learning using video games combines these two, making this an impressive option for learning. However, it is required not to lose sight of the fact that video games can only provide learning assistance, and they should not be used as a single way of learning.

Educational video games are exclusively designed to teach their players something new.
